<!--
**HibaElgohary/HibaElgohary** is a ✨ _special_ ✨ repository because its `README.md` appears on your GitHub profile.
-->
...
## 🌱 About Me
- 🔭 Working on a **React + TypeScript admin dashboard** with ShadCN components  
- 🌱 Learning **advanced React** and **Next.js API integration**  
- 👯 Looking to collaborate on **frontend projects with React & Next.js**  
